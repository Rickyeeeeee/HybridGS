...
from diff_bbsplat_rasterization import GaussianRasterizationSettings as BBSplatGaussianRasterizationSettings
from diff_bbsplat_rasterization import GaussianRasterizer as BBSplatGaussianRasterizer
...
def render_3dgs(viewpoint_camera, pc, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, 
...
def render_bbsplat(viewpoint_camera, pc, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, additional_return=True):
    """
    Render the scene. 
    ...
    raster_settings = BBSplatGaussianRasterizationSettings(
        image_height=int(viewpoint_camera.image_height),
        image_width=int(viewpoint_camera.image_width),
        tanfovx=tanfovx,
        tanfovy=tanfovy,
    ...
    rasterizer = BBSplatGaussianRasterizer(raster_settings=raster_settings)
